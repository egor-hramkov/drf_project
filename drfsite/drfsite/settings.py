...
SECRET_KEY = 'django-insecure-00jum0lamy&0pj_6x=lg80_$40qw7r8#0$^0_7&sc!n6(wpw2w'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [ #Для авторизации
        ...
        'rest_framework_simplejwt.authentication.JWTAuthentication', #Авторизация по JWT-токенам
    ]
}
